# Requirements Archive: v1.0 CV Generator MVP
...
Requirements for initial release. All mapped to roadmap phases and delivered.
...
Deferred to future release. Tracked but not in v1.0 roadmap.
...
Which phases covered which requirements. All delivered.
