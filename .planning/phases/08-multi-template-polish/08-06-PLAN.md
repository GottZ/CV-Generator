...
Example: `feat: add support for custom date formats`
...
- Include cvgen version and environment info
- Use issue templates when available

## Questions?

Open a discussion on GitHub or check the [FAQ](./FAQ.md).
```
...
- `ls docs/CUSTOMIZATION.md docs/CONTRIBUTING.md docs/FAQ.md docs/CHANGELOG.md`
- `grep "Configuration Cascade" docs/CUSTOMIZATION.md`
- `grep "Development Setup" docs/CONTRIBUTING.md`
- `grep "ATS" docs/FAQ.md`
  </verify>
  <done>
docs/CUSTOMIZATION.md, docs/CONTRIBUTING.md, docs/FAQ.md, and docs/CHANGELOG.md exist with comprehensive content.
  </done>
</task>
...
6. docs/FAQ.md answers common questions
7. docs/CHANGELOG.md has initial release notes
8. All markdown files are valid and well-formatted
</verification>
